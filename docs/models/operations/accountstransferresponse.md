...
```typescript
import { AccountsTransferResponse } from "@rails/sdk/models/operations";

let value: AccountsTransferResponse = {
  headers: {
    "key": [],
    "key1": [
      "<value 1>",
...
| `result`                                                | [models.TransferResult](../../models/transferresult.md) | :heavy_check_mark:                                      | N/A                                                     |